<?php
	...
	$titulos = array("PRIMERO.- ANTECEDENTES", "TERCERO.- Remuneración",
					 ...
					 "DÉCIMO TERCERA.- Periodo de prueba", "DÉCIMO CUARTA.- Cumplimiento del plazo del Contrato",
					 "DÉCIMO QUINTA .- Sistema de Gestión de la Seguridad y Salud en el Trabajo.");

	$textos = array("../reporte/articulo57/txt1.txt","../reporte/articulo57/txt3.txt",
					"../reporte/articulo57/txt4.txt","../reporte/articulo57/txt5.txt","../reporte/articulo57/txt6.txt",
					"../reporte/articulo57/txt7.txt","../reporte/articulo57/txt8.txt","../reporte/articulo57/txt9.txt",
					"../reporte/articulo57/txt10.txt","../reporte/articulo57/txt11.txt","../reporte/articulo57/txt11.txt",
					"../reporte/articulo57/txt13.txt","../reporte/articulo57/txt14.txt","../reporte/articulo57/txt15.txt");
	...
	$tex = utf8_decode(file_get_contents("../reporte/articulo57/txt8.1.txt"));
   	$tex = ltrim($tex, '?');
	...
	$tex2 = utf8_decode(file_get_contents("../reporte/articulo57/txt8.2.txt"));
   	$tex2 = ltrim($tex2, '?');
	...
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell(0,0,utf8_decode("DÉCIMO SEXTA .- Legislación aplicable.-"),'I');
	$pdf->Ln(4);

	$pdf->SetFont('Arial','',10);
	$tex2 = utf8_decode(file_get_contents("../reporte/articulo57/txt16.txt"));
   	$tex2 = ltrim($tex2, '?');
	$pdf->MultiCell(0,5,$tex2);
	$pdf->Ln(5);	
	...
	$l3 = utf8_decode("Extendido por duplicado en la Ciudad de Huaura el día $di de $nommes del $yi ");
	$pdf->Cell(0,0,$l3,'D');
	$pdf->Ln(28);
